...
class UserProfile(models.Model):
	...
	address_1 = models.CharField(max_length=512, verbose_name='Room/Floor/Block')
	address_2 = models.CharField(max_length=512, verbose_name='Street/Residential address')
	address_3 = models.CharField(max_length=512, verbose_name='')
	address_4 = models.CharField(max_length=512, verbose_name='Area')
	...
	employees = models.IntegerField(verbose_name='Employees number')
